...
export default function TransactionBuilder() {
  ...
  return (
    <div className="px-5 py-4 space-y-4">
      ...
      <button
        className={`w-full py-2.5 rounded-md text-xs font-medium transition-all focus:outline-none focus:ring-1 ${
          isLoading
            ...
            : "bg-red-900/90 hover:bg-red-800 text-zinc-100 border border-red-900/60 focus:ring-red-700/30"
        }`}
      ...
      {/* Error state */}
      {error && (
        <div className="py-2 px-3 bg-red-950/30 border border-red-900/30 rounded-md text-red-400 text-xs">
          {error}
        </div>
      )}
